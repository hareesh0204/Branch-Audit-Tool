...
* The following dependencies are not known to work with Spring Native: 'Spring REST Docs, Spring Boot DevTools, Spring
  Batch'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 audit:0.0.1-SNAPSHOT
```
